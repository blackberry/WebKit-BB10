...
var ITEM_HEIGHT = 99; // 99px, no border
...
function parseFromDateString(str) {
    ...
    if (str) {
        ...
        case DATE_TIME:
        case DATE_TIME_LOCAL:
            _currentDate = new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), now.getHours(), now.getMinutes()));
            break;
        case DATE:
            _currentDate = new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate()));
            break;
        case MONTH:
            _currentDate = new Date(Date.UTC(now.getFullYear(), now.getMonth()));
            break;
        }
    }
}
