...
#ifndef WebKitAccessibleWrapperBlackBerry_h
#define WebKitAccessibleWrapperBlackBerry_h
...
typedef struct _Relation {
    bb_a11y_relation_t m_type;
    WTF::Vector<bb_a11y_accessible_t> m_targets;
} Relation;
...
class WebKitAccessibleWrapperBlackBerry {
public:
    WebKitAccessibleWrapperBlackBerry(BlackBerry::WebKit::WebAccessibilityFunctionHandlerPrivate* /*handler*/);
    ~WebKitAccessibleWrapperBlackBerry();
    ...
    bb_a11y_status_t isApplication(const bb_a11y_accessible_t /*accessible*/, bool* result);
    bb_a11y_status_t getVersion(const bb_a11y_accessible_t /*accessible*/, char* axVersion, int maxSize, char** overflow);

private:
    BlackBerry::WebKit::WebAccessibilityFunctionHandlerPrivate* m_handler;

    WebCore::AccessibilityObject* getAccessibilityObject(const bb_a11y_accessible_t);
    bb_a11y_accessible_t getAccessible(WebCore::AccessibilityObject*);
    bb_a11y_accessible_t focusedElement(bb_a11y_accessible_t);
    Relation* newRelation(bb_a11y_relation_t relationType, AccessibilityObject* target);
    Relation* newRelation(bb_a11y_relation_t relationType, AccessibilityObject::AccessibilityChildrenVector& targets);
    Vector<Relation*> relationSet(const bb_a11y_accessible_t /*accessible*/);

    // Component

    WebCore::IntPoint pointForCoordinateType(WebCore::AccessibilityObject*, bb_a11y_coordinate_type_t, int, int);
    WebCore::IntRect rectForCoordinateType(WebCore::AccessibilityObject*, bb_a11y_coordinate_type_t, WebCore::IntRect);

    // Text

    friend class AccessibilityObject;
    WebCore::Editor* editorForAccessible(WebCore::AccessibilityObject*);

    static bool isTextObject(const AccessibilityObject* coreObject);

    // Table

    AccessibilityTable* coreTable(const bb_a11y_accessible_t /*accessible*/);

    // TableCell

    AccessibilityTableCell* coreTableCell(const bb_a11y_accessible_t /*accessible*/);
...
#endif // WebKitAccessibleWrapperBlackBerry_h
