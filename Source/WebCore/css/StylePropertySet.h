...
{
    ASSERT(!m_isMutable);
    return reinterpret_cast_ptr<const StylePropertyMetadata*>(&reinterpret_cast<const char*>((&static_cast<const ImmutableStylePropertySet*>(this)->m_storage))[m_arraySize * sizeof(CSSValue*)]);
}
