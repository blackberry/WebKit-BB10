...
public:
    ...
    public:
        AllMarkers()
            : MarkerTypes(Spelling | Grammar | TextMatch | Replacement | CorrectionIndicator | RejectedCorrection | Autocorrected | SpellCheckingExemption | DeletedAutocorrection | DictationAlternatives | AttributeText)
        {
        }
    };
    ...
    DocumentMarker(MarkerType, unsigned startOffset, unsigned endOffset, const String& description, const AttributeTextStyle& attributeTextStyle);
    ...
    AttributeTextStyle attributeTextStyle() const { return m_attributeTextStyle; }
    void setAttributeTextStyle(const AttributeTextStyle& style) { m_attributeTextStyle = style; }
    ...
    bool typesMatch(const DocumentMarker& o) const
    {
        ...
        if (m_type == AttributeText)
            return m_attributeTextStyle == o.m_attributeTextStyle;
...
private:
    ...
    AttributeTextStyle m_attributeTextStyle;
};
