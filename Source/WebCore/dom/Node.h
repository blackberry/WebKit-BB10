...
public:
    ...
    bool selfOrAncestorHasMouseOrTouchMoveListener() const { return getFlag(SelfOrAncestorHasMouseOrTouchMoveListenerFlag); }
    void setSelfOrAncestorHasMouseOrTouchMoveListener(bool flag) { setFlag(flag, SelfOrAncestorHasMouseOrTouchMoveListenerFlag); }
...
private:
    enum NodeFlags {
        ...
        SelfOrAncestorHasMouseOrTouchMoveListenerFlag = 1 << 29
    };
