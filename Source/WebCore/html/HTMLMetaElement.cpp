...
void HTMLMetaElement::process()
{
    ...
    if (equalIgnoringCase(name(), "cursor-event-mode"))
        document()->processCursorEventMode(content());
    if (equalIgnoringCase(name(), "touch-event-mode"))
        document()->processTouchEventMode(content());
#endif
