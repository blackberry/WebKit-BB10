    ...
    , m_isCapturingMouseEvents(false)
{
    ...
    // Plugins on blackberry must always get touch events
    document()->addListenerTypeIfNeeded(eventNames().touchstartEvent);
    document()->addListenerTypeIfNeeded(eventNames().touchmoveEvent);
    document()->addListenerTypeIfNeeded(eventNames().touchendEvent);
    document()->addListenerTypeIfNeeded(eventNames().touchcancelEvent);
#endif
}
