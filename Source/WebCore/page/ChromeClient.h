...
public:
    ...
    virtual Color underlayColor() const { return Color(); }
        ...
        enum StorageType {
            ...
            StorageSession,
            StorageIndexedDB,
            StorageWebFileSystem
        };

        virtual bool shouldAllowStorageRequest(StorageType, SecurityOrigin*, unsigned long long quota) = 0;
    ...
    virtual bool isPointerLocked() { return false; }
        ...
        enum VisibilityChangeType {
            NoVisibilityChange = 0,
            VisibilityChange,
            PotentialVisibilityChange,
            PotentialVisibilityChangeEnded
        };
        virtual void notifyVisibilityChange(VisibilityChangeType) = 0;
#if ENABLE(WEBGL)
        virtual void requestWebGLPermission(Frame*) = 0;
#endif
#if ENABLE(SVG)
        virtual void didSetSVGZoomAndPan(Frame*, unsigned short) = 0;
#endif
    virtual void invokeCard(const BlackBerry::Platform::String&) = 0;
#endif
