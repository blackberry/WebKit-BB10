...
{
    return String::fromUTF8(s_resource.getString(BlackBerry::Platform::PLUGIN_MISSING_TEXT));
}
...
{
    return String::fromUTF8(s_resource.getString(BlackBerry::Platform::TEXT_TRACK_HEADER_LABEL));
}
...
{
    return String::fromUTF8(s_resource.getString(BlackBerry::Platform::TEXT_TRACK_OFF_LABEL));
}

String textTrackNoLabelText()
{
    return String::fromUTF8(s_resource.getString(BlackBerry::Platform::TEXT_TRACK_NO_LABEL_LABEL));
}
#endif
