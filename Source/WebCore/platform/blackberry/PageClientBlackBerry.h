...
public:
    ...
    virtual double currentScale() const = 0;
    ...
    virtual AuthDialogResult authenticationChallenge(const WebCore::KURL&, const WebCore::ProtectionSpace&, WebCore::Credential&) = 0;
    virtual SaveCredentialDialogResult notifyShouldSaveCredential(bool) = 0;
    virtual bool isCredentialAutofillEnabled() const = 0;
    virtual bool isFormAutofillEnabled() const = 0;
