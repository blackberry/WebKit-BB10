...
public:
    ...
    static void openFileSystem(WorkerContext*, const KURL& rootURL, const String& mode, const String& basePath, const String& storageIdentifier, FileSystemType, long long size, bool create, int playerId, PassOwnPtr<AsyncFileSystemCallbacks>);
...
private:
    ...
    static void openFileSystemOnMainThread(ScriptExecutionContext*, const String& basePath, const String& storageIdentifier, FileSystemType, long long size, bool create, int playerId, WorkerPlatformAsyncFileSystemCallbacks*);
