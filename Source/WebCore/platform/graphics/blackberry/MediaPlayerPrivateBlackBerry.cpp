...
void MediaPlayerPrivate::load(const WTF::String& url)
{
    ...
    deleteGuardedObject(m_platformPlayer);
#if USE(ACCELERATED_COMPOSITING)
    m_platformPlayer = PlatformPlayer::create(this, tabId, isVideo, true, isMediaDocument, modifiedUrl.utf8().data());
#else
    m_platformPlayer = PlatformPlayer::create(this, tabId, isVideo, false, isMediaDocument, modifiedUrl.utf8().data());
#endif
