...
public:
    ...
    virtual void onMuteChanged(bool);
    ...
    virtual void onSetHolePunchRectEnabled(bool);
    virtual void onDestroyHolePunchRect();
    virtual void onUpdatePlatformLayer();
    ...
    virtual bool isElementFullscreen() const;
    ...
    virtual void setIsCamera(bool camera) { m_platformPlayerIsCamera = camera; }

    bool isCamera() const { return m_platformPlayerIsCamera; }

    // Play On stuff
    bool hasRemoteDisplays();
    bool isPresentationModeEnabled();
    bool isMiracastSupported();
    void setPresentationModeEnabled(bool);

    // Closed Captions stuff
    bool isAccessibilityCaptionsEnabled();
...
private:
    ...
    int m_hitTimeToPopupDialog;
    bool m_privateBrowsing;
    bool m_platformPlayerIsCamera;
};
