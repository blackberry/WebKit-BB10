...
{
    if (m_holePunchRectEnabled || rect.isEmpty()) {
...
void VideoLayerWebKitThread::setHolePunchRectEnabled(bool enabled)
{
    if (m_holePunchRectEnabled != enabled) {
        m_holePunchRectEnabled = enabled;
        if (m_holePunchRectEnabled)
