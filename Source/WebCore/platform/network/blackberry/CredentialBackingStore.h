...
private:
    ...
    bool getAllLoginsV1(Vector<ProtectionSpace>& protectionSpaces, Vector<Credential>& credentials);
    bool saveAllLogins(const Vector<ProtectionSpace>& protectionSpaces, const Vector<Credential>& credentials);
    bool getAllNeverRememberV1(Vector<ProtectionSpace>& protectionSpaces);
    bool saveAllNeverRemember(const Vector<ProtectionSpace>& protectionSpaces);

    void upgradeLoginsTable(unsigned existing, unsigned current);
    void upgradeNeverRememberTable(unsigned existing, unsigned current);
