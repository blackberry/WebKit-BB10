...
public:
    ...
    void initializePlatformRequest(BlackBerry::Platform::NetworkRequest&, bool cookiesEnabled, bool rereadCookies = false) const;
    ...
    String clientCertificateHandle() const { return m_clientCertificateHandle; }
    void setClientCertificateHandle(const String& handle) { m_clientCertificateHandle = handle; }

    static TargetType targetTypeFromMimeType(const String& mimeType);

    void clearHTTPContentLength();
    void clearHTTPContentType();
    void clearHTTPConditionalHeaders();
...
private:
    ...
    String m_clientCertificateHandle;
