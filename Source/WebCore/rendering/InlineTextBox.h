...
protected:
    ...
    void paintCompositionLineThrough(GraphicsContext*, const FloatPoint& boxOrigin, const CompositionLineThrough&);
#if PLATFORM(MAC)
...
private:
    ...
    void paintAttributeText(GraphicsContext*, const FloatPoint& boxOrigin, DocumentMarker*, RenderStyle*, const Font&);

#if PLATFORM(BLACKBERRY)
    void addFadeEffectIfNeeded(GraphicsContext*, const LayoutPoint&, const Font&);
#endif
