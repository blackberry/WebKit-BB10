...
public:
    ...
    LayoutRect absoluteLayoutOverflowRect() const { return m_absoluteOverflow ? m_absoluteOverflow->layoutOverflowRect() : layoutOverflowRect(); }
    LayoutRect absoluteVisualOverflowRect() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect() : visualOverflowRect(); }
    LayoutUnit rightAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().x() : visualOverflowRect().x(); }
    LayoutUnit bottomAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().y() : visualOverflowRect().y(); }
    LayoutUnit rightAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().maxX() : visualOverflowRect().maxX(); }
    LayoutUnit bottomAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().maxY() : visualOverflowRect().maxY(); }

    void addAbsoluteLayoutOverflow(const LayoutRect&);
    void addAbsoluteVisualOverflow(const LayoutRect&);
