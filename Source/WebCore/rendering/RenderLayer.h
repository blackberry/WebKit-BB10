...
private:
    ...
    void setHasFixedContainer(bool b) { m_hasFixedContainer = b; }

    bool allowsCompositingForFixedPosition() const;

    bool hasFixedAncestorInDOMTree() const { return m_hasFixedAncestorInDOMTree; }
    void setHasFixedAncestorInDOMTree(bool b) { m_hasFixedAncestorInDOMTree = b; }
#endif
#endif
...
#if PLATFORM(BLACKBERRY)
    bool m_fixedWithNonFixedOverlap : 1;
