...
public:
    ...
    void absoluteQuadsForRange(Vector<FloatQuad>& quads, unsigned startOffset = 0, unsigned endOffset = UINT_MAX, bool useSelectionHeight = false, bool* wasFixed = 0)
    {
        return containerQuadsForRange(quads, 0, startOffset, endOffset, useSelectionHeight, wasFixed);
    }

    void containerQuadsForRange(Vector<FloatQuad>&, RenderLayerModelObject* container, unsigned startOffset = 0, unsigned endOffset = UINT_MAX, bool useSelectionHeight = false, bool* wasFixed = 0);
