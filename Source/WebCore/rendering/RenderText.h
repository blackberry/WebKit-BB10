...
public:
    ...
    void containerQuadsForRange(Vector<FloatQuad>&, RenderBoxModelObject* container, unsigned startOffset = 0, unsigned endOffset = UINT_MAX, bool useSelectionHeight = false, bool* wasFixed = 0);
