...
public:
    ...
    OverflowScrolling overflowScrolling() const { return static_cast<OverflowScrolling>(rareInheritedData->overflowScrolling); }
#endif
...
#endif
#if ENABLE(OVERFLOW_SCROLLING)
    void setOverflowScrolling(OverflowScrolling v) { SET_VAR(rareInheritedData, overflowScrolling, v); }
#endif
...
#endif
#if ENABLE(OVERFLOW_SCROLLING)
    static OverflowScrolling initialOverflowScrolling() { return OSAuto; }
#endif
#if ENABLE(DASHBOARD_SUPPORT)
