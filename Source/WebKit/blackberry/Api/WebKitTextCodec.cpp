...
WTF::Base64DecodePolicy base64DecodePolicyForWebCore(Base64DecodePolicy policy)
{
...
{
    Vector<char> result;
    if (!WTF::base64Decode(base64.c_str(), base64.length(), result, base64DecodePolicyForWebCore(policy)))
        return false;
