...
public:
    ...
    const WebCore::Texture::HostType& contents() const { return m_contents; }
    void setContents(const WebCore::Texture::HostType&);
...
private:
    ...
    bool m_drawsContent;
    WebCore::Texture::HostType m_contents;
    WebCore::Texture::HostType m_uploadedContents;
