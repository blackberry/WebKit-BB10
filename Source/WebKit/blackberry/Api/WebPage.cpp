...
void WebPage::setParagraphExpansionScrollMargin(const Platform::IntSize& scrollMargin)
{
    d->m_selectionHandler->setParagraphExpansionScrollMargin(scrollMargin);
}

bool WebPage::isEndOfDocumentSelected() const
{
    return d->m_selectionHandler->isEndOfDocumentSelected();
}
...
Platform::IntPoint WebPage::adjustDocumentKineticScrollPosition(const Platform::IntPoint& documentScrollPosition, const Platform::IntRect& documentPaddingRect)
{
