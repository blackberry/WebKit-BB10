...
public:
    ...
    Platform::IntPoint adjustDocumentKineticScrollPosition(const Platform::IntPoint& documentScrollPosition, const Platform::IntRect& documentPaddingRect);
    ...
    void setParagraphExpansionScrollMargin(const Platform::IntSize&);
    bool isEndOfDocumentSelected() const;
