...
#include <BlackBerryPlatformSecurityOrigin.h>
#include <BlackBerryPlatformStorageQuotaManager.h>
...
public:
    ...
    enum SaveCredentialDialogResult {
        SaveCredentialDialogNotShown,
        SaveCredentialDialogNeverForThisSite,
        SaveCredentialDialogNotNow,
        SaveCredentialDialogYes
    };
    ...
    virtual void notifyAdjustedScaleAndScrollPosition(const Platform::FloatPoint& newDocumentScrollPosition, double newScale) = 0;
    ...
    virtual void showFormControls(bool previousActive = false, bool nextActive = false) = 0;
    virtual void hideFormControls() = 0;
    virtual void showVirtualKeyboard(bool) = 0;

    virtual void requestSpellCheckingOptions(imf_sp_text_t&, BlackBerry::Platform::IntRect& caretRect, bool shouldMoveDialog) = 0;
    ...
    virtual void notifyCaretChanged(const Platform::IntRect& documentCaretRect, bool userTouchTriggered, bool isSingleLineInput = false, const Platform::IntRect& singleLineDocumentBoundingBox = Platform::IntRect(), const Platform::IntPoint& scrollPosition = Platform::IntPoint(-1, -1), bool textFieldIsEmpty = false) = 0;
    ...
    // Database interface.
    virtual bool shouldAllowStorageRequest(BlackBerry::Platform::StorageType, const BlackBerry::Platform::SecurityOrigin&, unsigned long long quota) = 0;
    ...
    virtual void animateDeniedBlockZoom() = 0;

    virtual void setPreventsScreenIdleDimming(bool noDimming) = 0;
    virtual AuthDialogResult authenticationChallenge(const unsigned short* realm, unsigned realmLength, BlackBerry::Platform::String& username, BlackBerry::Platform::String& password, BlackBerry::Platform::String& requestURL, bool isProxy) = 0;
    virtual SaveCredentialDialogResult notifyShouldSaveCredential(bool isNew) = 0;
    ...
    virtual unsigned downloadRequested(Platform::FilterStream*, const BlackBerry::Platform::String& suggestedFilename, unsigned parentDownloadId, bool confirmed) = 0;
    ...
    virtual void notifyWillUpdatePersistentCache() = 0;
    virtual void notifyDidLoadFromPersistentCache() = 0;
    ...
    virtual void invokeCard(const Platform::String&) = 0;

    // SecurityOrigin pointer passed in here will be deleted immediately after
    // these callback return, so no reference to them after returns.
    virtual bool allowDisplayingInsecureContent(bool enabledPerSettings, const BlackBerry::Platform::SecurityOrigin*, const BlackBerry::Platform::String& url) = 0;
    virtual bool allowRunningInsecureContent(bool enabledPerSettings, const BlackBerry::Platform::SecurityOrigin*, const BlackBerry::Platform::String& url) = 0;
    virtual void didDisplayInsecureContent() = 0;
    virtual void didRunInsecureContent(const BlackBerry::Platform::SecurityOrigin*, const BlackBerry::Platform::String& url) = 0;

    virtual bb_a11y_bridge_t accessibilityBridge() = 0;
    virtual bb_a11y_accessible_t createAccessible() = 0;
    virtual void registerRootAccessible(bb_a11y_accessible_t /*rootAccessible*/) = 0;
    virtual void unregisterRootAccessible(bb_a11y_accessible_t /*rootAccessible*/) = 0;
    virtual void addAccessible(bb_a11y_accessible_t /*accessible*/) = 0;
    virtual void removeAccessible(bb_a11y_accessible_t /*accessible*/) = 0;
    virtual void onUnhandledAccessibilityTouchEvent(const BlackBerry::Platform::RawTouchEvent& /*event*/) = 0;

    virtual bool hasView() = 0;
    virtual void scrollByCompositor(int dx, int dy, bool allowOverscroll = true) = 0;
    virtual void windowToScreenCoordinates(BlackBerry::Platform::IntRect& caretRect) = 0;

    virtual void queueAccessibilityTouchEvent(BlackBerry::Platform::TouchEvent&) = 0;
};
