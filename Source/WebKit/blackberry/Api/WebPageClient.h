...
public:
    ...
    virtual void setMetaHeaders(const ScopeArray<BlackBerry::Platform::String>& headers, unsigned int headersSize) = 0;
    ...
    virtual bool authenticationChallenge(const unsigned short* realm, unsigned int realmLength, BlackBerry::Platform::String& username, BlackBerry::Platform::String& password, BlackBerry::Platform::String& requestURL, bool isProxy) = 0;
