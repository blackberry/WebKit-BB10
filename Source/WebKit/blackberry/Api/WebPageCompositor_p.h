...
public:
    ...
    WebCore::LayerCompositingThread* scrollLayer() const { return m_scrollLayer.get(); }
    void setScrollLayer(WebCore::LayerCompositingThread* scrollLayer) { m_scrollLayer = scrollLayer; }
    ...
    WebCore::LayerRenderer* getLayerRenderer() { return m_layerRenderer.get(); }
...
private:
    ...
    RefPtr<WebCore::LayerCompositingThread> m_scrollLayer;
