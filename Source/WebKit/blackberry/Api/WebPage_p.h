...
public:
    ...
    void download(WebCore::Frame*, const Platform::NetworkRequest&, PreDownloadHandlingPolicy, bool needReferer);
    void download(WebCore::Frame*, const WebCore::ResourceRequest&, PreDownloadHandlingPolicy);
    ...
    void notifyAdjustedZoom(const Platform::FloatPoint& newPos, double newZoom);
