...
DEFINE_STATIC_LOCAL(String, BlackBerryFileSystemAPISandboxed, (ASCIILiteral("BlackBerryFileSystemAPISandboxed")));
...
WebSettings* WebSettings::standardSettings()
{
    ...
    settings->m_private->setBoolean(BlackBerryFileSystemAPISandboxed, true);
...
bool WebSettings::fileSystemAPISandboxed() const
{
    return m_private->getBoolean(BlackBerryFileSystemAPISandboxed);
}

void WebSettings::setFileSystemAPISandboxed(bool enable)
{
    return m_private->setBoolean(BlackBerryFileSystemAPISandboxed, enable);
}
