...
public:
    ...
    virtual bool shouldAllowStorageRequest(WebCore::ChromeClient::StorageType, WebCore::SecurityOrigin*, unsigned long long quota);
    virtual void exceededDatabaseQuota(Frame*, const String&, DatabaseDetails);
    virtual PassRefPtr<DateTimeChooser> openDateTimeChooser(DateTimeChooserClient*, const DateTimeChooserParameters&);
