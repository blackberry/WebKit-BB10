...
public:
    void autofillAuthenticationChallenge(PageClientBlackBerry*, const ProtectionSpace&, BlackBerry::Platform::String& username, BlackBerry::Platform::String& password);
    void autofillPasswordForms(PageClientBlackBerry*, PassRefPtr<HTMLCollection> docForms);
