...
public:
    ...
    virtual bool shouldUsePluginDocument(const String&) const;
    ...
    virtual PassRefPtr<Widget> createJavaAppletWidget(const IntSize&, HTMLAppletElement*, const KURL&, const Vector<String>&, const Vector<String>&);
    ...
    virtual bool allowDisplayingInsecureContent(bool enabledPerSettings, SecurityOrigin*, const KURL&);
    virtual bool allowRunningInsecureContent(bool enabledPerSettings, SecurityOrigin*, const KURL&);
...
private:
    void receivedData(DocumentLoader*, const char*, int);
