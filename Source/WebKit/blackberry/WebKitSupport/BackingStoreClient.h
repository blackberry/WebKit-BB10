...
class ScrollNotificationSuppressor {
public:
    ScrollNotificationSuppressor(BackingStoreClient* backingStoreClient, bool shouldSuppress)
        : m_backingStoreClient(backingStoreClient)
        , m_wasScrollNotificationSuppressed(backingStoreClient->isScrollNotificationSuppressed())
    {
        m_backingStoreClient->setIsScrollNotificationSuppressed(shouldSuppress);
    }

    ~ScrollNotificationSuppressor()
    {
        m_backingStoreClient->setIsScrollNotificationSuppressed(m_wasScrollNotificationSuppressed);
    }

private:
    BackingStoreClient* m_backingStoreClient;
    bool m_wasScrollNotificationSuppressed;
};
