...
void visibleTextQuads(const WebCore::Range&, WTF::Vector<WebCore::FloatQuad>& quads, SelectionOverlay::Selection* = 0, WebCore::GraphicsLayer* rootOverlay = 0, bool useSelectionHeight = false);
void visibleTextQuads(const WebCore::VisibleSelection&, WTF::Vector<WebCore::FloatQuad>& quads, SelectionOverlay::Selection* = 0, WebCore::GraphicsLayer* = 0);
void clipSelectionToRenderer(SelectionOverlay::Selection&, WebCore::RenderObject*, WebCore::GraphicsLayer* rootLayer);
...
bool shouldLearnText(const WebCore::Element*);
bool isElementAndDocumentAttached(const WebCore::Element*);

bool isUserSelectNone(WebCore::Node*);
} // DOMSupport
} // WebKit
} // BlackBerry
