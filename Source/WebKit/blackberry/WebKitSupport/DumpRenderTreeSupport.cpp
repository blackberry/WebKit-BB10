...
bb_a11y_accessible_t DumpRenderTreeSupport::getRootAccessibleElement(WebCore::Frame* frame)
{
#if HAVE(ACCESSIBILITY)
    return frame->document()->axObjectCache()->rootObject()->axObjectID();
#else
    return 0;
#endif
}

bb_a11y_accessible_t DumpRenderTreeSupport::getFocusedAccessibleElement(WebCore::Frame* /*frame*/)
{
    notImplemented();
    return 0;
}
