    ...
    , m_hasWindowVisibleRectCalculated(false)
{
    ...
    if (layerRenderer->isRenderView()) { // #document case
        ...
        m_viewportSize = viewportAccessor->roundToPixelFromDocumentContents(WebCore::FloatRect(view->visibleContentRect(false /*includeScrollbars*/))).size();
        ...
        m_viewportSize = viewportAccessor->roundToPixelFromDocumentContents(WebCore::FloatRect(scrollableArea->visibleContentRect(false /*includeScrollbars*/))).size();
