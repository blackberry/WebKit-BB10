...
void PagePopup::initialize(WebPage* webPage)
{
    ...
    writeDocument(webPage);
    installDOMFunction(webPage->d->mainFrame());
}

void PagePopup::writeDocument(WebPage* webPage)
{
    ...
    m_client->writeDocument(source);
    webPage->loadString(BlackBerry::Platform::String(source.toString()),
        BlackBerry::Platform::String::fromUtf8("popupwebview"),
        BlackBerry::Platform::String::fromUtf8("text/html"),
        BlackBerry::Platform::String::emptyString());
}
