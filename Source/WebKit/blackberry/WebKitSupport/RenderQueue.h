...
public:
    ...
    void saveAndClearScrollRenderJobs();
    void restoreSavedScrollRenderJobs();
...
private:
    ...
    Platform::IntRectRegion m_savedVisibleScrollRegion;
    Platform::IntRectRegion m_savedNonVisibleScrollRegion;
