...
public:
    ...
    void setSelection(WebCore::IntPoint base, WebCore::IntPoint extent, const bool isBaseHandleGrabbed, const bool limitedToBoundingBox);
    ...
    void selectionPositionChanged(bool forceUpdateWithoutChange = false, bool updateSelectionOverlay = true);

    void setCaretPosition(const WebCore::IntPoint&);

    bool lastUpdatedExtentPointIsValid() const { return m_lastUpdatedExtentPointIsValid; }
...
private:
    ...
    bool updateOrHandleInputSelection(WebCore::VisibleSelection& newSelection, const WebCore::IntPoint& relativeBase, const WebCore::IntPoint& relativeExtent, const bool isBaseHandleGrabbed);
    ...
    bool m_caretActive;
    bool m_lastUpdatedExtentPointIsValid;
    ...
    WebCore::Color m_lastOverlayColor;
};
