...
public:
    ...
    void animationFrameChanged(BlackBerry::Platform::Animation<SelectionHandler>* animation, double currentValue, double previousValue);
...
private:
    ...
    void ensureSelectedTextVisible(const WebCore::VisiblePosition endPos);
