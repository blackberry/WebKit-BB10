    ...
    case Platform::TouchPoint::TouchPressed:
        {
            ...
            // NOTE: Node::selfOrAncestorHasMouseOrTouchMoveListener works for both the AT_TARGET and BUBBLE phases of event handling.
            // The CAPTURING phase is intentionally not handled by it (for the sake of being practical with what we have on the Web).
            if (!possibleTargetNodeForMouseMoveEvents || (!possibleTargetNodeForMouseMoveEvents->selfOrAncestorHasMouseOrTouchMoveListener() && !m_convertTouchToMouse))
