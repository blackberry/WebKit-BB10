...
public:
    ...
    void handleTouchPoint(const Platform::TouchPoint&);
    ...
    void mouseDidMoveOverElement(const WebCore::HitTestResult&, unsigned);
    void notifyVisibilityChange(WebCore::ChromeClient::VisibilityChangeType);
...
private:
    ...
    // Hover Hack variables
    bool m_touchPressed;
    bool m_mouseClickDelayed;
    WebCore::Element* m_mouseOverElement;
    WebCore::ChromeClient::VisibilityChangeType m_visibilityChange;
    int m_timersPotentiallyCausingVisibilityChange;
};
