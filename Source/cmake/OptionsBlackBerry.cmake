...
set(WTF_USE_HARFBUZZ 1)
add_definitions(-DWTF_USE_HARFBUZZ=1)
#set(WTF_ENABLE_OPENTYPE_VERTICAL 1)
#add_definitions(-DWTF_ENABLE_OPENTYPE_VERTICAL=1)
...
macro(FIND_STAGING_LIBRARY _var _libname)
  set(${_var} -l${_libname} CACHE STRING ${_libname})
endmacro()
...
FIND_STAGING_LIBRARY(BB_A11Y_AT_LIBRARY bb_a11y_at)
FIND_STAGING_LIBRARY(BB_A11Y_RT_LIBRARY bb_a11y_rt)
...
FIND_STAGING_LIBRARY(HARFBUZZ_LIBRARY harfbuzzng)
...
# (Required for users with cmake version 2.8.8 or lower)
...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_DFG_JIT ON)
...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_FIXED_REPORTED_SIZE ON)
