...
bool LoadHTMLStringItem::invoke() const
{
    ...
    BlackBerry::WebKit::DumpRenderTree::currentInstance()->page()->loadString(content.get(), strlen(content.get()), baseURL.get(), "text/html", unreachableURLSize ? unreachableURL.get() : 0);
    return true;
}
